export default function ContactBanner() {
  return (
    <section className="relative bg-[#f7f3f1] h-[350px] overflow-hidden">
      {/* Top Icon */}
      <div className="absolute top-4 left-1/2 -translate-x-1/2 text-gray-500 text-5xl">
        ✧
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 h-full flex items-center">
        <div>
          <h1 className="text-6xl font-serif text-[#1f1f1f] mb-4">
            Contact
          </h1>
