    ...
    <section className="bg-[#f7f3f1] py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        <div className="text-center mb-10 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-6xl font-serif text-[#2f2f2f]">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {packages.map((item) => (
            <div
              key={item.name}
              className="bg-white p-6 md:p-8 hover:shadow-xl transition-all duration-300"
            >
              <h3 className="text-2xl md:text-3xl font-serif text-[#2f2f2f] mb-4">
                {item.name}
              </h3>

              <div className="mb-8">
                <span className="text-3xl md:text-5xl text-[#c48a6a]">
                  {item.price}
                </span>
              </div>
